[my-first-project-2ed5] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [my-first-project-2ed5] container is NOT running**.

.. tip::
   You must have your [my-first-project-2ed5] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/aanthonylin/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=44889  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='aanthonylin'  \-\-env DOCKERUSERNAME='aanthonylin'  \-\-env MQTTUSERNAME='aanthonylin'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   aanthonylin/my-first-project-2ed5-amd64 (https://hub.docker.com/r/aanthonylin/my-first-project-2ed5-amd64)
...
.. important::
   docker run -d -p 52113:52113 -p 54993:54993 -p 56503:56503 \-\-env TSS=0 \-\-env SOLUTIONNAME=my-first-project-2ed5 \-\-env SOLUTIONDAG=solution_preprocessing_dag-my-first-project-2ed5 \-\-env GITUSERNAME=aanthonylin  \-\-env GITREPOURL=https://github.com/aanthonylin/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=52113  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=54993  \-\-env SOLUTIONVIPERVIZPORT=56503 \-\-env DOCKERUSERNAME='aanthonylin'  \-\-env EXTERNALPORT=44889 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='aanthonylin' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  aanthonylin/my-first-project-2ed5-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=56503
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=52113
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - aanthonylin/my-first-project-2ed5-amd64
...
It can be accessed by entering: http://localhost:54993
...
.. important::
   http://localhost:56503/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:56503/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:56503/<html file>
...
[my-first-project-2ed5] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/aanthonylin/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/my-first-project-2ed5
...
.. important::
   https://my-first-project-2ed5.readthedocs.io
...
.. important::
   solution_preprocessing_dag-my-first-project-2ed5
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=52113, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38133, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35339, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36565, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=39127, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40643, HPDEHOST=127.0.1.1, HPDEPORT=42319, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36023

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4621-my-first-project-2ed5,solution_preprocessing_dag-my-first-project-2ed5, python-preprocess-3897-my-first-project-2ed5,solution_preprocessing_dag-my-first-project-2ed5, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
